...
class ProductSpendingChart extends React.Component {
  ...
  render() {
    ...
    const config = {
      chart: { type: 'spline' },
      title: {
        text: `Purchasing History For ${this.props.productName}`,
      },
      yAxis: {
        title: {
          text: 'Qty',
